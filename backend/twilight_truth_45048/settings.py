"""
Django settings for twilight_truth_45048 project.
...
ROOT_URLCONF = 'twilight_truth_45048.urls'
...
WSGI_APPLICATION = 'twilight_truth_45048.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "twilight_truth_45048 API",
    "DESCRIPTION": "API documentation for twilight_truth_45048 App",
    "VERSION": "v1",
}
